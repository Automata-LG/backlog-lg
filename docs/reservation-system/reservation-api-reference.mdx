...
#### POST /external/app/reservation/price-items
...
```json
{
  ...
  "name": "런치 코스 (수정)",
  "basePrice": 55000,
  "idForBefore": "other-price-item-uuid"
}
```
...
```json
{
  ...
  "startsAfter": "2025-06-01",
  "startsBefore": "2025-06-30",
  "createdAfter": "2025-05-01",
  "createdBefore": "2025-05-31",
  "memName": "홍길동",
  "memNo": "1234567890",
  "phoneNumber": "+821012345678",
  "sn": "LGR",
...
```json
{
  "memberId": "member-uuid",  // optional (memberId 또는 memNo 중 하나 필수)
  "memNo": "1234567890",      // optional (memberId 또는 memNo 중 하나 필수)
  "kind": "HOME_APPLIANCE_CONCIERGE"  // optional (MembershipBenefitsKind)
}
```
  ...
  "list": [
    {
      ...
      "reservation": null  // 또는 { "id": "reservation-uuid" }
    }
  ]
}
```
