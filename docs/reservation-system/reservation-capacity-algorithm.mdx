...
현재 구현에서 `availableCapacity`는:
- **사용되지 않은 유닛들의 총 용량**을 나타냅니다
- 유닛이 부분적으로 사용되어도 전체가 사용된 것으로 계산됩니다
- 따라서 실제 남은 자리보다 적게 표시될 수 있습니다

**예시**:
- 4인 테이블에 2명 배치 → remaining = 0 (실제로는 2자리 남음)
- 이는 향후 개선이 필요한 부분입니다
