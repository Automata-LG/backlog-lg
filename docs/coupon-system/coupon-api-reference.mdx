  ...
  "list": [
    {
      ...
      "coupon": {
        "id": "uuid-here", // 쿠폰 ID (베이스 쿠폰 ID, 외부 시스템 쿠폰만 null)
  ...
  ```json
  {
    "list": [
      ...
      },
      {
        ...
        "coupon": {
          "id": "660e8400-e29b-41d4-a716-446655440001", // 쿠폰 ID
    ...
    "list": [
      {
        ...
        "cautions": "•예약 변경 및 취소는 방문 24시간 전까지 가능합니다.",
        "policy": {
          "applicable_to": {
            "display_text": "SKS 다이닝 레스토랑 이용 시",
            "rules": {
              "location": "SKS_DINING",
              "usage_period": "MEMBERSHIP_YEAR"
            }
          }
        },
        "discountType": "RATE",
